...
description: "Use Ergo for upload external recordings and understand what to expect."
keywords: ["Upload external recordings","Meetings and notes","Ergo docs"]
---

# Upload external recordings

Audience: User; Admin; Super Admin · Access: Live · Requires: External recording
