...
description: "Use using deal and meeting context across Ergo AI, search, and automation workflows."
keywords: ["Using deal and meeting context","Ergo AI, search, and automation","Ergo docs"]
---

# Using deal and meeting context

Audience: User; Admin; Super Admin · Access: Beta/Gated · Requires: CRM, Notetaker
