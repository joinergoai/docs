...
- For primary admins, secondary admins, RevOps, sales leaders, and operators who manage rollout; users who complete setup or use this workflow day to day; spectators with limited meeting, reporting, or shared-link access; desktop users capturing meetings from the Ergo Desktop app.
