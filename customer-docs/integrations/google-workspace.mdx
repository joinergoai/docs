...
description: "Connect, verify, and maintain the Google Workspace integration in Ergo."
keywords: ["Google Workspace","Integrations","Ergo docs"]
---

# Google Workspace

Audience: User; Admin; Super Admin; Spectator · Access: Live · Requires: Google Workspace
...
- Confirm the required source is connected or available: Google Workspace.
